...
const Hero = () => {
  ...
  >
    <div
      className="hero-inner resp-px resp-grid resp-gap"
      style={{
        maxWidth: "82rem",
        margin: "0 auto",
    ...
    >
      ...
      <div>
        ...
        >
          "{t.hero.quote} <br /> {t.hero.quoteBreak}"
        </p>
        ...
        >
          ...
          >
            {t.common.book} <span className="btn-arrow"><ArrowUpRight size={18} strokeWidth={2.5} /></span>
          </button>

          <button
            onClick={() => {
              window.open("https://wa.me/918624011185", "_blank", "noopener,noreferrer");
            }}
            style={{
              display: "inline-flex",
              alignItems: "center",
